    ...
    <div class="container">
        ...
        <div class="product-detail">
            <div class="product-image">
                <?php if($produk['foto']): ?>
                    <img src="uploads/<?php echo $produk['foto']; ?>" alt="<?php echo $produk['nama']; ?>">
                <?php else: ?>
            ...
            <div class="product-details">
                ...
                <div class="detail-row">
                    <strong>Harga:</strong>
                    <span class="price-large">Rp <?php echo number_format($produk['harga'], 0, ',', '.'); ?></span>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <span><?php echo date('d/m/Y H:i', strtotime($produk['created_at'])); ?></span>
                </div>

                <div class="detail-row">
                    <strong>Terakhir diupdate:</strong>
                    <span><?php echo date('d/m/Y H:i', strtotime($produk['updated_at'])); ?></span>
                </div>
